...
function Main({ language }) {
  const { profile, contacts, skills, skill,  education, experience } = content[language];
  ...
  return (
    <main className="Main">
      <section className="Main--section">
        ...
        <InfoContainer title={skill.title} className="Main--section-skill">
          <ul>{skill.content.map(Item)}</ul>
        </InfoContainer>
      </section>
      <section className="Main--section">
